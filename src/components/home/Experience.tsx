...
const Experience = () => {
  return (
    <section className="w-full scroll-m-10 relative flex items-center justify-center overflow-hidden bg-dark-blue">
        ...
        <div className="py-8 md:py-12 flex flex-col gap-6 md:gap-8 w-full relative pl-6 md:pl-8">
          ...
          <div className="w-full flex flex-col gap-10">
            {experienceData.map((curExp, i) => (
              <div
                key={i}
                className="w-full flex-col md:flex-row flex gap-5 md:gap-0"
              >
